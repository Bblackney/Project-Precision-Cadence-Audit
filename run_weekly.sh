...
# 0) Wait for network. The Mac may still be waking from sleep; a DNS failure
#    would otherwise abort the whole run. Poll up to ~10 min for the SalesLoft
#    API host to resolve before scoring.
NET_OK=0
